...
Màn Hình Quản Trị - Báo Cáo Nhanh 
@endsection
...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-danger shadow h-100 py-2">
            ...
            <div class="card-footer">
                <button class="btn btn-danger" id="btnRefreshDocgiaCount">Refresh dữ liệu</button>
            </div>
        </div>
    </div>
    <!-- mượn sách -->
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            ...
            <div class="card-footer">
                <button class="btn btn-success" id="btnRefreshMuonsachCount">Refresh dữ liệu</button>
            </div>
        </div>
    </div>
    <!-- thu thư -->
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            ...
            <div class="card-footer">
                <button class="btn btn-warning" id="btnRefreshThuthuCount">Refresh dữ liệu</button>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        function getDataDocgiaCount() {
            // Nhờ AJAX gởi request đến url /admin/api/getProductCount
            $.ajax('{{ route('backend.api.getDocgiaCount') }}', {
                success: function(data) {
        ...
        function getDataMuonsachCount() {
            // Nhờ AJAX gởi request đến url /admin/api/getProductCount
            $.ajax('{{ route('backend.api.getMuonsachCount') }}', {
                success: function(data) {
        ...
        function getDataThuthuCount() {
            // Nhờ AJAX gởi request đến url /admin/api/getProductCount
            $.ajax('{{ route('backend.api.getThuthuCount') }}', {
                success: function(data) {
