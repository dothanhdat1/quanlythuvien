...
<form name="frmEditThuthu" id="frmEditThuthu" method="post" action="{{ route('backend.thuthu.update', ['id' => $thuthu->id]) }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <a href="{{ route('backend.thuthu.index') }}" class="btn">Quay về</a>
