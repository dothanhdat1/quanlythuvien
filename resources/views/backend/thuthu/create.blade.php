...
<form name="frmCreateThuthu" id="frmCreateThuthu" method="post" action="{{ route('backend.thuthu.store') }}" enctype="multipart/form-data">
  {{ csrf_field() }} 
  ...
  <a class="btn btn-primary" href="{{ route('backend.thuthu.index') }}" class="btn">Quay về</a>
