...
<form name="frmEditSach" id="frmEditSach" method="post" action="{{ route('backend.sach.update', ['id' => $sach->id]) }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <a href="{{ route('backend.sach.index') }}" class="btn">Quay về</a>
