...
<form name="frmCreateSach" id="frmCreateSach" method="post" action="{{ route('backend.sach.store') }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <a class="btn btn-primary" href="{{ route('backend.sach.index') }}" class="btn">Quay về</a>
