...
<form name="frmEditDocgia" id="frmEditDocgia" method="post" action="{{ route('backend.docgia.update', ['id' => $docgia->id]) }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <a href="{{ route('backend.docgia.index') }}" class="btn">Quay về</a>
