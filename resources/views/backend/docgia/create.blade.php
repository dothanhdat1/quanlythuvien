...
<form name="frmCreateDocgia" id="frmCreateDocgia" method="post" action="{{ route('backend.docgia.store') }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <a class="btn btn-primary" href="{{ route('backend.docgia.index') }}" class="btn">Quay về</a>
